<body class="animsition">
        ...
        <div class="page-container">
            <div class="main-content">
                <div class="container">
                    <div class="col-md-12">
                    <!-- DATA TABLE -->
                        <h3 class="title-5 m-b-35">data table prestasi non akademik</h3>
    ...
    <!-- Modal Add Produk-->
        <form id="add-row-form" action="<?php echo base_url().'presnon/crud/simpan'?>" method="post">
        ...
        <!-- Modal Update Produk-->
        <form id="add-row-form" action="<?php echo base_url().'presnon/crud/update'?>" method="post">
            <div class="modal fade" id="ModalUpdate" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                   <div class="modal-content">
                       ...
                       <div class="modal-body">
                            <div class="form-group">
                                <input type="text" name="id_presnon" class="form-control" placeholder="ID" readonly>
                            </div>
                            <div class="form-group">
                               <input type="text" name="npm" class="form-control" placeholder="NPM" required>
                            </div>
        ...
        <!-- Modal Hapus Produk-->
        <form id="add-row-form" action="<?php echo base_url().'presnon/crud/delete'?>" method="post">
    ...
    $(document).ready(function(){
      ...
      var table = $("#mytable").dataTable({
          initComplete: function() {
              ...
              processing: true,
              serverSide: true,
              ajax: {"url": "<?php echo base_url().'presnon/crud/get_guest_json'?>", "type": "POST"},
                    columns: [
                        {"data": "id_presnon"},
                        {"data": "npm"},
                        {"data": "jenis_prestasi"},
