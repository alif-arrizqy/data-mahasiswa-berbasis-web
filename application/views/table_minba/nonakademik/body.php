<body class="animsition">
        ...
        <div class="page-container">
            <div class="main-content">
                <div class="container">
                    <div class="col-md-12">
                    <!-- DATA TABLE -->
                        <h3 class="title-5 m-b-35">data table minat dan bakat non akademik</h3>
    ...
    <!-- Modal Add Produk-->
        <form id="add-row-form" action="<?php echo base_url().'minba_non/crud/simpan'?>" method="post">
                   ...
                   <div class="modal-content">
                       ...
                       <div class="modal-body">
                            ...
                            <div class="form-group">
                               ...
                               <textarea name="jenis_minba" class="form-control" placeholder="Jenis minat dan bakat"></textarea>
                            </div>
                       </div>
        ...
        <!-- Modal Update Produk-->
        <form id="add-row-form" action="<?php echo base_url().'minba_non/crud/update'?>" method="post">
            <div class="modal fade" id="ModalUpdate" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                   <div class="modal-content">
                       ...
                       <div class="modal-body">
                            <div class="form-group">
                                <input type="text" name="id_minba_non" class="form-control" placeholder="ID" readonly>
                            </div>
                            <div class="form-group">
                               <input type="text" name="npm" class="form-control" placeholder="NPM" required>
                            </div>
        ...
        <!-- Modal Hapus Produk-->
        <form id="add-row-form" action="<?php echo base_url().'minba_non/crud/delete'?>" method="post">
    ...
    $(document).ready(function(){
      ...
      var table = $("#mytable").dataTable({
          initComplete: function() {
              ...
              processing: true,
              serverSide: true,
              ajax: {"url": "<?php echo base_url().'minba_non/crud/get_guest_json'?>", "type": "POST"},
                    columns: [
                        {"data": "id_minba_non"},
                        {"data": "npm"},
                        {"data": "jenis_minba"},
        ...
        // get Edit Records
            ...
            var id_minba_non=$(this).data('id_minba_non');
            var npm=$(this).data('npm');
            var jenis_minba=$(this).data('jenis_minba');
            $('#ModalUpdate').modal('show');
            $('[name="id_minba_non"]').val(id_minba_non);
            $('[name="npm"]').val(npm);
            $('[name="jenis_minba"]').val(jenis_minba);
            });
        // End Edit Records
