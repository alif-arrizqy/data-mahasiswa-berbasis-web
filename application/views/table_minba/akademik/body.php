<body class="animsition">
        ...
        <div class="page-container">
            <div class="main-content">
                <div class="container">
                    <div class="col-md-12">
                    <!-- DATA TABLE -->
                        <h3 class="title-5 m-b-35">data table minat dan bakat akademik</h3>
    ...
    <!-- Modal Add Produk-->
        <form id="add-row-form" action="<?php echo base_url().'minba_aka/crud/simpan'?>" method="post">
        ...
        <!-- Modal Update Produk-->
        <form id="add-row-form" action="<?php echo base_url().'minba_aka/crud/update'?>" method="post">
            <div class="modal fade" id="ModalUpdate" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                   <div class="modal-content">
                       ...
                       <div class="modal-body">
                            <div class="form-group">
                                <input type="text" name="id_minba_ak" class="form-control" placeholder="ID" readonly>
                            </div>
                            <div class="form-group">
                               <input type="text" name="npm" class="form-control" placeholder="NPM" required>
                            </div>
        ...
        <!-- Modal Hapus Produk-->
        <form id="add-row-form" action="<?php echo base_url().'minba_aka/crud/delete'?>" method="post">
    ...
    $(document).ready(function(){
      ...
      var table = $("#mytable").dataTable({
          initComplete: function() {
              ...
              processing: true,
              serverSide: true,
              ajax: {"url": "<?php echo base_url().'minba_aka/crud/get_guest_json'?>", "type": "POST"},
                    columns: [
                        {"data": "id_minba_ak"},
                        {"data": "npm"},
                        {"data": "jenis_minba"},
        ...
        // get Edit Records
            ...
            var id_minba_ak=$(this).data('id_minba_ak');
            var npm=$(this).data('npm');
            var jenis_minba=$(this).data('jenis_minba');
            $('#ModalUpdate').modal('show');
            $('[name="id_minba_ak"]').val(id_minba_ak);
            $('[name="npm"]').val(npm);
