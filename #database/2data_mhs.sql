...
/*Table structure for table `minba_ak` */

DROP TABLE IF EXISTS `minba_ak`;

CREATE TABLE `minba_ak` (
  `id_minba_ak` int(11) NOT NULL AUTO_INCREMENT,
  `npm` varchar(15) DEFAULT NULL,
  `jenis_minba` text,
  PRIMARY KEY (`id_minba_ak`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

/*Data for the table `minba_ak` */

/*Table structure for table `minba_non` */

DROP TABLE IF EXISTS `minba_non`;

CREATE TABLE `minba_non` (
  `id_minba_non` int(11) NOT NULL AUTO_INCREMENT,
  `npm` varchar(15) DEFAULT NULL,
  `jenis_minba` text,
  PRIMARY KEY (`id_minba_non`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

/*Data for the table `minba_non` */
...
(1,'065117136','juara 222\r\nlomba game\r\ndebat indo'),
(3,'065117188','juara makan');

/*Table structure for table `presnon` */

DROP TABLE IF EXISTS `presnon`;

CREATE TABLE `presnon` (
  `id_presnon` int(11) NOT NULL AUTO_INCREMENT,
  `npm` varchar(20) DEFAULT NULL,
  `jenis_prestasi` text,
  PRIMARY KEY (`id_presnon`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;

/*Data for the table `presnon` */

insert  into `presnon`(`id_presnon`,`npm`,`jenis_prestasi`) values 
(1,'065117157','pemain futsal terbaik'),
(2,'065117122','juara basket bogor');
